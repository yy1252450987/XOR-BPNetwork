...
void IterNeuralNetwrok(Network *NeuralNetwork, Data train_data, double error, double eta, char *log, char *err)
{
  int num=0,n,i,j,k;
...
int main(int argc, char *argv[])
{
  if(argc != 3){
    ...
    printf("Usage : ./bpnetwork_nobias log-filename err-filename\n");
    return 0;
  }
  else{
    Network XORNetwork;
